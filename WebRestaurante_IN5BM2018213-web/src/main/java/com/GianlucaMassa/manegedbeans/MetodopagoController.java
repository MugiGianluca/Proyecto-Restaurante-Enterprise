package com.GianlucaMassa.manegedbeans;

import com.GianlucaMassa.entities.Metodopago;
import com.GianlucaMassa.manegedbeans.util.JsfUtil;
import com.GianlucaMassa.manegedbeans.util.JsfUtil.PersistAction;
import com.GianlucaMassa.sessionbeans.MetodopagoFacadeLocal;
...
public class MetodopagoController implements Serializable {
    ...
    @EJB
    private MetodopagoFacadeLocal ejbFacade;
    ...
    private MetodopagoFacadeLocal getFacade() {
        return ejbFacade;
    }
